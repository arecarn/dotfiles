<!-- Generated by `uv run inv gen-instructions` from agents/.config/ai-instructions/{build-ci.md, docker-makefile.md, merge-requests.md, output-formatting.md, python.md, teams.md, local-pointer.md}.

...
machines run both repos, and that is where the damage would land. `StowPlan.stow` creates
...
The pre-create is `manage.agents.skills_hub.pre_create`, and `tests/test_skills_hub.py` is the

...
map('n', 'yow', ':<C-U>set wrap!<CR>:set wrap?<CR>')
map('n', 'yos', ':<C-U>set spell!<CR>:set spell?<CR>')
map('n', 'yon', ':<C-U>set number!<CR>:set number?<CR>')
map('n', 'yor', ':<C-U>set relativenumber!<CR>:set relativenumber?<CR>')
map('n', 'yol', ':<C-U>set list!<CR>:set list?<CR>')
map('n', 'yoh', ':<C-U>set hlsearch!<CR>:set hlsearch?<CR>')
map('n', 'yoc', ':<C-U>set cursorline!<CR>:set cursorline?<CR>')

<!-- Generated by `uv run inv gen-instructions` from agents/.config/ai-instructions/{build-ci.md, comments.md, docker-makefile.md, merge-requests.md, output-formatting.md, prose-style.md, python.md, review-before-posting.md, teams.md, local-pointer.md}.
